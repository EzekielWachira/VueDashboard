        ...
        <v-card>
          ...
          <v-form class="px-3" ref="form">
            <v-card-text>
              ...
              <v-textarea label="Project Description" v-model="content" :rules="inputRules" prepend-icon="edit"></v-textarea>
              <v-col cols="12" lg="6">
                <v-menu ref="menu1"
                        v-model="menu1"
                        ...
                        min-width="290px">
                  <template v-slot:activator="{on}">
                    <v-text-field v-model="dateFormated"
                                  label="Date"
...
export default {
  ...
  data: vm => ({
    ...
    menu1: false,
    inputRules: [
      v => v.length >= 3 || 'Minimum is 3 characters'
    ]
  }),
  methods: {
    formatDate (date) {
